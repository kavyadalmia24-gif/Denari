...
import { LayoutDashboard, Calculator, GraduationCap, BrainCircuit, Bot, X, Sparkles, PieChart, CandlestickChart } from 'lucide-react';
        ...
        <div className="p-6">
          <div className="glass-card p-4 rounded-2xl border border-white/60 bg-gradient-to-br from-indigo-500/5 to-violet-500/5">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-indigo-400 to-violet-400 flex items-center justify-center text-white font-bold shadow-md">
                G
              </div>
              <div>
            ...
            <div className="w-full bg-slate-200 h-1.5 rounded-full overflow-hidden">
              <div className="bg-gradient-to-r from-indigo-500 to-violet-500 w-[65%] h-full rounded-full" />
            </div>
            <p className="text-[10px] text-slate-400 mt-2 text-right">Level 5 Investor</p>
          </div>
        </div>
      </div>
    </>
